 ...
 */
export function generateExcelFile(data: ExcelUserData[], filename: string = 'utilisateurs.xlsx'): Buffer {
  ...
  return writeFile(workbook, filename, { type: 'buffer', bookType: 'xlsx' });
}
